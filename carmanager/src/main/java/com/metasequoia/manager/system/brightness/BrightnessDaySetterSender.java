 ...
 */
public class BrightnessDaySetterSender extends SettingsIntListener implements ISender<Integer> {
    public static final String TAG = "BrightnessDaySetter";
    /**
     * 当前白天/黑夜模式
     */
    private BrightnessMode mBrightnessMode = BrightnessMode.DAYTIME;
    private BooleanState mAutoBrightness = BooleanState.TRUE;
    public BrightnessDaySetterSender(Context context) {
        super(context, SettingsConfig.SETTINGS_BRIGHTNESS_DAY);
    }
    ...
    public void setBrightness(int value){
        ...
        if(mBrightnessMode == BrightnessMode.DAYTIME){
            send(value);
        }
    }
